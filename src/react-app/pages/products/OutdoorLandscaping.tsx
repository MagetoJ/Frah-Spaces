      ...
      <section className="relative py-20 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Outdoor &
            <span className="block text-primary">Landscaping</span>
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            Products for gardens, patios, and external living spaces to enhance your outdoor environment.
          </p>
        </div>
      </section>
              ...
              <Card key={idx} className="group overflow-hidden border-2 hover:border-primary/50 transition-all flex flex-col shadow-sm">
                <div className="aspect-[16/9] w-full overflow-hidden relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <Badge className="bg-green-500 border-0 shadow-lg">Verified Quality</Badge>
                  </div>
                </div>
