...
export default function InteriorFinishes() {
  const items = [
    { 
      ...
      <section className="relative py-20 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Interior
            <span className="block text-primary">Finishes</span>
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            Focusing on hardware, lighting, or cabinetry to complete your interior spaces.
          </p>
        </div>
      </section>
