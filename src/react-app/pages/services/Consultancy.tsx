...
import { Mail, MessageCircle, Phone, Shield, Hammer } from "lucide-react";

export default function Consultancy() {
  const options = ["Feasibility Studies", "Statutory Approvals", "Material Selection", "Cost Estimation"];

  const handleWhatsApp = (phone = "254721175735") => {
    window.open(`https://wa.me/${phone}?text=Hello Frah Spaces, I'm interested in learning more about your Consultancy services. Could you please provide more information?`, "_blank");
  };

  const handleEmail = () => {
    window.location.href = `mailto:admin@frahspaces.com?subject=Inquiry about Consultancy services`;
  };
      ...
      <section className="relative py-20 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            Providing advisory services for feasibility studies and technical audits to guide your projects.
          </p>
        </div>
      </section>
              ...
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Expert advice at every step. We provide strategic guidance on land use, regulatory compliance, and investment feasibility.
                  </p>
                </div>
              </div>
