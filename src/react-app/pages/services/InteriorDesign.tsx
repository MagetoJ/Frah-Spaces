...
import { Mail, MessageCircle, Phone, Layout, Hammer } from "lucide-react";

export default function InteriorDesign() {
  const options = ["Space Planning", "Gypsum & Finishes", "Custom Cabinetry", "Furniture Selection"];

  const handleWhatsApp = (phone = "254721175735") => {
    window.open(`https://wa.me/${phone}?text=Hello Frah Spaces, I'm interested in learning more about your Interior Design services. Could you please provide more information?`, "_blank");
  };

  const handleEmail = () => {
    window.location.href = `mailto:admin@frahspaces.com?subject=Inquiry about Interior Design services`;
  };
      ...
      <section className="relative py-20 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            Showcasing our approach to aesthetics, furniture selection, and space optimization.
          </p>
        </div>
      </section>
              ...
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Creating bespoke interior environments that reflect your personality. We focus on luxury, comfort, and sophisticated material selection.
                  </p>
                </div>
              </div>
